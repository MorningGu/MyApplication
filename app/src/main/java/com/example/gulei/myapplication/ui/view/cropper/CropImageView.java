...
public class CropImageView extends View implements TouchEventDetector.TouchEventListener {
   ...
   private Drawable[] mDragDrawables = {getResources().getDrawable(R.mipmap.ic_crop_drag_x),
           getResources().getDrawable(R.mipmap.ic_crop_drag_y),
           getResources().getDrawable(R.mipmap.ic_crop_drag_x),
           getResources().getDrawable(R.mipmap.ic_crop_drag_y)};
   ...
   public void initialize(Bitmap bitmap, CropImageActivity.CropParam param) {
      initialize(bitmap, 0, param);
   }

   public void initialize(Bitmap bitmap, int degrees) {
      initialize(bitmap, degrees, new CropImageActivity.CropParam());
   }

   public void initialize(Bitmap bitmap, int degrees, CropImageActivity.CropParam param) {
      mCropParam = param;
   ...
   private void calculateCropParams(RotateBitmap bitmap) {
      ...
      CropImageActivity.CropParam param = new CropImageActivity.CropParam();
   ...
   protected void onDraw(Canvas canvas) {
      canvas.save();
      if (mCropBitmap != null && mCropBitmap.getBitmap()!=null && !mCropBitmap.getBitmap().isRecycled()) {
