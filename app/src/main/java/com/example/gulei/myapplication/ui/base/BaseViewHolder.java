...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * @param imageUri
     * @param defResourceId
     * @param size  Config.IMAGE_SMALL = 200;Config.IMAGE_NORMAL = 800;Config.IMAGE_BIG = 1200;
     * @return
     */
